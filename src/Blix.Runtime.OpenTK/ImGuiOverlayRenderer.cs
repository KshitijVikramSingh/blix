...
// OpenGL backend for the diagnostics overlay. Owns the ImGui context, the GL
// font texture + draw pipeline, and input wiring; the actual panel layout
// lives in the backend-agnostic DebugOverlayUi (shared with the Vulkan
// backend). This class is now just "ImGui draw data -> GL".
