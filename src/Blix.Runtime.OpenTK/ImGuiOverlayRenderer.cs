...
internal sealed class ImGuiOverlayRenderer : IDisposable
{
    ...
    private void DrawDiagnostics(DebugSystem debugSystem)
    {
        ...
        ImGui.SetNextWindowSize(new System.Numerics.Vector2(440.0f, 520.0f), ImGuiCond.FirstUseEver);
        ...
        IReadOnlyList<DebugTimerEntry> timers)
    {
        ...
        {
            ImGui.SameLine(); ImGui.TextDisabled("|"); ImGui.SameLine();
            ImGui.TextColored(new System.Numerics.Vector4(1.0f, 0.85f, 0.0f, 1.0f),
    ...
    private static readonly System.Numerics.Vector2 SparklineSize = new(120.0f, 24.0f);

    private static readonly System.Numerics.Vector4 InfoColor  = new(0.65f, 0.85f, 1.00f, 1.0f);
    private static readonly System.Numerics.Vector4 WarnColor  = new(1.00f, 0.78f, 0.30f, 1.0f);
    private static readonly System.Numerics.Vector4 ErrorColor = new(1.00f, 0.45f, 0.45f, 1.0f);
    ...
    // (DrawFreezeBar was removed in Phase 11 — the freeze toggle now
    // lives in the right edge of the status bar.)
