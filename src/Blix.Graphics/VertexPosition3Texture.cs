...
public readonly record struct VertexPosition3Texture(GraphicsVector3 Position, GraphicsVector2 TextureCoordinate)
{
    ...
    public static VertexBufferData CreateBufferData(
        IReadOnlyList<VertexPosition3Texture> vertices,
    ...
    public static byte[] Pack(IReadOnlyList<VertexPosition3Texture> vertices)
    {
