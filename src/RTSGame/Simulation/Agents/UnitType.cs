    ...
    int CarryCapacity)
{
    ...
    public static readonly UnitType Soldier =
        new("soldier", BodyClass.Foot, AgentDefaults.Radius, 1.70f, 0f, 0);
    ...
    public static readonly UnitType LightCavalry =
        new("light cavalry", BodyClass.Foot, AgentDefaults.Radius, 3.50f, 0f, 0);
    ...
    public static readonly UnitType HeavyCavalry =
        new("heavy cavalry", BodyClass.Heavy, AgentDefaults.HeavyRadius, 2.50f, 2.6f, 0);
