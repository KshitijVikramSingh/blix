...
internal static class MapSweep
{
    ...
    /// </summary>
    /// <remarks>
    /// §151. Measured, not chosen: 2 across the sweep, and the shape of them is the argument for §150.
    ...
    /// </para>
    /// </remarks>
    private const int KnownShortfalls = 2;
        ...
        bool eroded)
    {
        ...
        try
        {
            ...
            Console.WriteLine($"    {TerrainCriteria.LastSteepest}");
