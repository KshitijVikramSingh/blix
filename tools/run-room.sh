#!/usr/bin/env bash
# Launcher for Blix.Labs.Character.Room — the character lab's ROOM: contact, with nothing else
# in the picture.
#
...
PROJECT="$REPO_ROOT/src/Blix.Labs.Character.Room/Blix.Labs.Character.Room.csproj"
APPHOST="$REPO_ROOT/src/Blix.Labs.Character.Room/bin/Debug/net8.0/Blix.Labs.Character.Room"
