...
PROJECT="$REPO_ROOT/src/Blix.Demos.Bulwark/Blix.Demos.Bulwark.csproj"
PUBLISH_DIR="$REPO_ROOT/src/Blix.Demos.Bulwark/bin/Publish"
RID="osx-arm64"
...
BUILD_SHADERS="$REPO_ROOT/src/Blix.Demos.Bulwark/bin/Debug/net8.0/$RID/Shaders"
[ -d "$BUILD_SHADERS" ] || BUILD_SHADERS="$REPO_ROOT/src/Blix.Demos.Bulwark/bin/Debug/net8.0/Shaders"
