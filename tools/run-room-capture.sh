#!/usr/bin/env bash
# Launcher for Blix.Labs.Character.Capture — the character lab's ROOM: contact, with nothing else
# in the picture.
#
...
PROJECT="$REPO_ROOT/src/Blix.Labs.Character.Capture/Blix.Labs.Character.Capture.csproj"
APPHOST="$REPO_ROOT/src/Blix.Labs.Character.Capture/bin/Debug/net8.0/Blix.Labs.Character.Capture"
