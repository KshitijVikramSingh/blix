...
PROJECT="$REPO_ROOT/src/Blix.Demos.Runner/Blix.Demos.Runner.csproj"
PUBLISH_DIR="$REPO_ROOT/src/Blix.Demos.Runner/bin/Publish"
RID="osx-arm64"
...
BUILD_SHADERS="$REPO_ROOT/src/Blix.Demos.Runner/bin/Debug/net8.0/$RID/Shaders"
[ -d "$BUILD_SHADERS" ] || BUILD_SHADERS="$REPO_ROOT/src/Blix.Demos.Runner/bin/Debug/net8.0/Shaders"
