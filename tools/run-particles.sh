...
PROJECT="$REPO_ROOT/src/Blix.Demos.VulkanParticles/Blix.Demos.VulkanParticles.csproj"
PUBLISH_DIR="$REPO_ROOT/src/Blix.Demos.VulkanParticles/bin/Publish"
RID="osx-arm64"
...
BUILD_SHADERS="$REPO_ROOT/src/Blix.Demos.VulkanParticles/bin/Debug/net8.0/$RID/Shaders"
[ -d "$BUILD_SHADERS" ] || BUILD_SHADERS="$REPO_ROOT/src/Blix.Demos.VulkanParticles/bin/Debug/net8.0/Shaders"
